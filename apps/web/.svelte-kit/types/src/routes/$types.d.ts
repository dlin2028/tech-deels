...
type LayoutRouteId = RouteId | "/" | "/(auth)/login" | "/(auth)/signup" | "/admin" | "/affiliate-disclosure" | "/deals/[id]" | "/deals/new" | "/guidelines" | "/mod/queue" | "/notifications" | "/privacy" | "/saved" | "/search" | "/terms" | "/u/[username]" | null
type LayoutParams = RouteParams & { id?: string; username?: string }
